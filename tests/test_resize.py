...
class TestResizingMethods:
    ...
    def test_nearest_neighbor(self):
        ...
        gray = np.random.randint(0, 256, (1, 200), dtype=np.uint8)
        resized = resize_gray_width(gray, new_width=150, resample=Image.Resampling.NEAREST)
        assert resized.shape == (1, 150)
        assert resized.dtype == np.uint8
    ...
    def test_lanczos(self):
        ...
        gray = np.random.randint(0, 256, (1, 200), dtype=np.uint8)
        resized = resize_gray_width(gray, new_width=150, resample=Image.Resampling.LANCZOS)
        assert resized.shape == (1, 150)
        assert resized.dtype == np.uint8
    ...
    def test_bicubic(self):
        ...
        gray = np.random.randint(0, 256, (1, 200), dtype=np.uint8)
        resized = resize_gray_width(gray, new_width=150, resample=Image.Resampling.BICUBIC)
        assert resized.shape == (1, 150)
        assert resized.dtype == np.uint8
